...
if __name__ == '__main__':
    try:
        ...
        os.system("nginx -s stop 2>/dev/null")
        print(f"{colorama.Fore.LIGHTRED_EX}[{colorama.Fore.GREEN}{chr(10003)}{colorama.Fore.LIGHTRED_EX}] {colorama.Fore.LIGHTYELLOW_EX}Shutdown{colorama.Fore.LIGHTGREEN_EX} NGINX{colorama.Fore.RESET}            ")